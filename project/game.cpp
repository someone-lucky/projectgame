...
/*! В данной функции описана сама игра, в том числе взаимодествие персонажей между собой и игрока с главным героем, а также отрисовку персонажей и саму карту. Она отвечает за старт и конец игры */
int main() {
