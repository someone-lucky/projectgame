...
using namespace sf;
//! Класс противника
/*! В нем описаны взаимдоействия персонажа с объектами карты, физика передвижений,
 * анимация движений и прорисовка */
class enemy {
public:
...
/*! Рассмотрение проходит путем нахождения положения персонажа относительно карты
 * и проверкой на пересечение с непроходимыми объектами */
    void StuckX() {
 ...
 * а также за его исчезновение при гибели */
